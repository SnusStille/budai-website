    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-sm text-muted">Experience the future of AI</span>
        </motion.div>
        ...
        >
          <span className="block">Your intelligent</span>
          <span className="block text-gradient mt-1">AI Assistant</span>
        </motion.h1>
        ...
        >
          BudAI is a next-generation platform designed to help people and businesses work smarter. Understand context, automate tasks, and unlock new possibilities.
        </motion.p>
        ...
        >
          {[
            ...
            { icon: Bot, label: "Future AI Agents" },
          ].map((item) => (
        ...
        >
          ...
          >
            <span className="text-xs text-muted/40 uppercase tracking-widest">Discover</span>
